...
export interface OVM_L1ERC721GatewayInterface extends utils.Interface {
  functions: {
...
export interface OVM_L1ERC721Gateway extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OVM_L1ERC721GatewayInterface;
